...
fig.add_trace(go.Scatter(x=forecast_range_df.index, y=forecast_df['High'], line=dict(color='#0000ff', width=5), name='forecast'))

fig.add_trace(go.Scatter(x=forecast_range_df.index, y=forecast_df['Low'], line=dict(color='#0000ff', width=5), name='forecast'))
