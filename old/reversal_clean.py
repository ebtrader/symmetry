...
selection_df_high = selection_df['High'].iloc[-1]       # LAST ROW FOR REVERSAL
# selection_df_high = selection_df['High'].iloc[0]      # FIRST ROW FOR COPY
diff = selection_df_high - df_high                      # get the diff
print(diff)

# use for reversal and TURN OFF FOR COPY
